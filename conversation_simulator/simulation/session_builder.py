...
class SimulationSessionBuilder:
    ...
    def build(self) -> SimulationSession:
        ...
        return SimulationSession(
            ...
            intent_extractor=self._intent_extractor or ZeroshotIntentExtractor(self.chat_model, max_concurrency=self.max_concurrent_conversations),
            outcome_detector=self._outcome_detector or ZeroshotOutcomeDetector(self.chat_model, max_concurrency=self.max_concurrent_conversations),
            adversarial_tester=self._adversarial_tester or ZeroShotAdversarialTester(self.chat_model, max_concurrency=self.max_concurrent_conversations),
