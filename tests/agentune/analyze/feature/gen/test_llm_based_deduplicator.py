...
async def test_llm_based_deduplicator(llm_with_spec_for_dedup: LLMWithSpec) -> None:
    ...
    query_list = [Query('q1', 'Did the seller offer a discount?', types.boolean),
                  ...
                  Query('q10', 'What is the count of product name mentions by the seller?', types.int64),
                  ...
                  Query('q18', 'How many times did the seller mention the product name?', types.int64),
                  ...
                  Query('q21', 'How many objections did the customer raise?', types.int64),
