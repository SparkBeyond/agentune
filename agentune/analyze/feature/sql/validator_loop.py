...
async def _validate_and_retry(params: ValidateAndRetryParams,
    ...
    try:
        feature = params.feature_ctor(params.conn, params.sql_feature_spec, params.params, params.secondary_tables, params.primary_table_name,
                                      params.index_column_name, params.timeout)
...
async def _handle_error(params: ValidateAndRetryParams,
    ...
    new_spec = await params.corrector.correct(params.sql_feature_spec, error)
    if new_spec is None:
        return None
    return await _validate_and_retry(
        attrs.evolve(params, sql_feature_spec=new_spec),
